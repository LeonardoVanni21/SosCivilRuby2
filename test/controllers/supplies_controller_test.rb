...
class SuppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post supplies_url, params: { supply: { details: @supply.details, name: @supply.name, stock: @supply.stock, unity_of_measure: @supply.unity_of_measure } }
    end
  ...
  test "should update supply" do
    patch supply_url(@supply), params: { supply: { details: @supply.details, name: @supply.name, stock: @supply.stock, unity_of_measure: @supply.unity_of_measure } }
